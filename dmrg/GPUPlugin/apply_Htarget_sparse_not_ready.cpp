...
void apply_Htarget_sparse(
    ...
    Kokkos::View<const KokkosScalar*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged> Xin_,
    Kokkos::View<KokkosScalar*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged>       Yout_)
{
	...
	for (jpatch = 1; jpatch <= npatches; jpatch++) {
		...
		if (nconnection >= 1) {
			...
			for (iconnection = 1; iconnection <= nconnection; iconnection++) {
				...
				a_array_[ibatch - 1] = reinterpret_cast<const KokkosScalar*>(pA);
...
template void apply_Htarget_sparse<double>(
    SizeType,
    SizeType,
    VectorSizeType,
    VectorSizeType,
...
template void apply_Htarget_sparse<std::complex<double>>(
    ...
    std::complex<double>**,
    const VectorIntegerType&,
    Kokkos::View<const Kokkos::complex<double>*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged>,
    Kokkos::View<Kokkos::complex<double>*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged>);
